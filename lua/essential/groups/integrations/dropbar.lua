...
return function(c, o)
  ...
  for kind, key in pairs(require("essential.kinds")) do
  ...
  for kind, key in pairs({
    ...
    Repeat = "purple",
    IfStatement = "purple",
    ElseStatement = "purple",
    ForStatement = "purple",
    WhileStatement = "purple",
    DoStatement = "purple",
    SwitchStatement = "purple",
    CaseStatement = "purple",
    BreakStatement = "purple",
    ContinueStatement = "purple",
    GotoStatement = "purple",
